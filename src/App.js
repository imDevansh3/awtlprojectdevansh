  ...
  constructor(props) {
            ...
            <div className="passwordItem" key={index}>
                <div className="listItem">
                    ...
                    <div className="iconContainer">
                        ...
                        <div
                            className="icon"
                            onClick={() => this.editPassword(index)}
                        >
    ...
    render() {
        ...
        return (
          ...
          <img src="images/logo.jpg" alt="Password Manager Logo" className="logo" />
                <div className="content">
                    ...
                    <div className="savedPasswordsSection">
                        <h2 className="subHeading">Your Passwords</h2>
